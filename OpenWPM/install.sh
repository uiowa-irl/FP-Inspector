...
sudo apt-get install -y firefox htop git python-dev libxml2-dev libxslt-dev libffi-dev libssl-dev build-essential xvfb xserver-xephyr vnc4server libboost-python-dev libleveldb-dev libjpeg-dev curl wget
